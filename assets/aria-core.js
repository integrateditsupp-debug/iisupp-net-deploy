...
(function () {
  ...
  var MILESTONES = [
    ...
    { status: "done",    title: "Enterprise governance & federal procurement readiness", desc: "2026 — Project AEGIS launched. Eleven enterprise-grade governance policies authored, executive-approved, and published publicly at iisupport.net/governance — Human Rights & Due Diligence, Modern Slavery Statement (Canadian Act S-211), Information Security (ISO/IEC 27001 / NIST CSF / ITSG-33), Supplier Code of Conduct, Privacy (PIPEDA), Acceptable Use of AI (ISO/IEC 42001 / NIST AI RMF), Code of Conduct & Business Ethics, Anti-Bribery & Anti-Corruption (CFPOA / FCPA / U.K. Bribery Act), Environmental Policy, Occupational Health & Safety (OHSA / ISO 45001-aligned), and the Incident & Grievance Response Procedure (UNGP Principle 31). Calibrated to Ontario, Canadian federal, and international standards. Registered as a qualified supplier on CanadaBuys and the SAP Ariba Business Network. Human Rights Assessment submitted to, and shared with, the Government of Canada. Actively bidding on federal, provincial, enterprise, financial, legal, and Crown-corporation opportunities." },
